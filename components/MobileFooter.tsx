    ...
    <>
      ...
      {listOpen && (
        <>
          ...
          />
          <div className="fixed bottom-16 left-0 right-0 z-20 md:hidden bg-background border-t border-border shadow-md animate-in slide-in-from-bottom-2 duration-150">
